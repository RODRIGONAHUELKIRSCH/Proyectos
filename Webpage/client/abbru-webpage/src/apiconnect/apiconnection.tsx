...
export const fetchActiveImages = async (): Promise<EventImage[]> => {
  try {
...
export const fetchInactiveImages = async (): Promise<EventImage[]> => {
  try {
...
export const fetchImagesByState = async (state: string): Promise<EventImage[]> => {
  try {
...
export const fetchMagazinesByYearRange = async (startYear: String, endYear: String) => {
  try {
...
export const obtenerUltimaRevistaEnlace = async (): Promise<string | null> => {
  try {
...
// Define la interfaz de la respuesta que esperamos del backend
...
export const obtenerUltimaRevista = async (): Promise<Revista | null> => {
  try {
...
export const obtenerProductoPorCategoria = async (categoria: string)=> {
  try {
