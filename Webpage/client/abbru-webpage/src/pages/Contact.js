...
const Contact = () => {
    return (_jsxs(ThemeProvider, { theme: theme, children: [_jsx(CssBaseline, {}), _jsxs(Grid, { container: true, component: "main", sx: { height: '100vh', width: '100vw', backgroundColor: '#ffffff', position: 'relative', margin: 0 }, children: [_jsxs(Grid, { container: true, component: "div", size: { xs: 12, sm: 12, md: 12 }, sx: {
                            ...
                            backgroundPosition: 'center', }, children: _jsxs(Box, { sx: {
                                padding: 0,
                                ...
                                marginLeft: { sm: '0.5rem', md: '1.5rem' },
                                    ...
                                    }, children: "Contactanos a trav\u00E9s de estos medios:" }), _jsx(Typography, { variant: "body2", sx: {
                                        mx: { xs: '5%', sm: '2%', md: '2%' },
                                        fontFamily: 'Josefin Sans',
                                        ...
                                        color: '#ffffff',
                                        textDecoration: 'underline'
                                    }, children: "Chaco" }), _jsx(Typography, { variant: "body2", sx: {
                                        mx: { xs: '5%', sm: '2%', md: '2%' },
                                        fontFamily: 'Josefin Sans',
                                        fontSize: { xs: '12px', sm: '14px', md: '16px', lg: '18px' },
                                        mt: { xs: '0.5rem', sm: '0.5rem', md: '1rem' },
                                        color: '#ffffff',
                                    }, children: "Tel.:(362)-4430466/4438409 - Resistencia" }), _jsx(Typography, { variant: "body2", sx: {
                                        mx: { xs: '5%', sm: '2%', md: '2%' },
                                        fontFamily: 'Josefin Sans',
                                        fontSize: { xs: '12px', sm: '14px', md: '18px', lg: '20px' },
                                        mt: { xs: '0.5rem', sm: '0.5rem', md: '1rem' },
                                        ...
                                        color: '#ffffff',
                                        textDecoration: 'underline'
                                    }, children: "Urgencias al:" }), _jsx(Typography, { variant: "body2", sx: {
                                        mx: { xs: '5%', sm: '2%', md: '2%' },
                                        fontFamily: 'Josefin Sans',
                                        fontSize: { xs: '12px', sm: '14px', md: '16px', lg: '18px' },
                                        mt: { xs: '0.5rem', sm: '0.5rem', md: '1rem' },
                                        color: '#ffffff',
                                    }, children: "Telefono: (362)-4335995" }), _jsx(Typography, { variant: "body2", sx: {
                                        mx: { xs: '5%', sm: '2%', md: '2%' },
                                        fontFamily: 'Josefin Sans',
                                        fontSize: { xs: '12px', sm: '14px', md: '16px', lg: '18px' },
                                        mt: { xs: '0.5rem', sm: '0.5rem', md: '1rem' },
                                        color: '#ffffff',
                                    }, children: "Email: gerencia@ortopediaabbruzzese.com.ar" }), _jsx(Typography, { variant: "body2", sx: {
                                        mx: { xs: '1%', sm: '2%', md: '2%' },
                                        fontFamily: 'Josefin Sans',
                                        fontSize: { xs: '12px', sm: '14px', md: '16px' },
                                        mt: { xs: '0.5rem', sm: '0.5rem', md: '1rem' },
                                        color: '#ffffff',
                                    }, children: "Contamos con oficinas en  Misiones, Corrientes y Formosa." })] }) }), _jsxs(Grid, { container: true, component: "div", size: { xs: 12, sm: 12, md: 12, lg: 12 }, sx: {
                            position: 'absolute',
                            minWidth: '100vw',
                            bottom: 0,
                            height: '12vh',
