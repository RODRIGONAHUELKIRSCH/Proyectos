...
public class UserController {
    ...
    public ResponseEntity<List<DTOUser>> getAllUsers() {
        List<DTOUser> users = uservice.getUsers();
    ...
    public ResponseEntity<Map<String, String>> findByEmail(@RequestParam("Email") String email) {
        try {
            DTOUser user = uservice.findUserByEmail(email);

            
            emailService.sendPasswordRecoveryEmail(user.getEmail(), user.getNombre(), user.getPassword());
